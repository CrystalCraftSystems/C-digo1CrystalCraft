                ...
                <?php if (isset($registros)): ?>
                    ...
                    <?php foreach ($registros as $registro): ?>
                        <tr>
                            ...
                            <td>
                                <a class="button is-small is-info" href="./index.php?acao=editar&idRegistro=<?=$registro->getIdRegistro()?>">Editar</a>
                                <a class="button is-small is-danger" href="./index.php?acao=excluir&idRegistro=<?=$registro->getIdRegistro()?>">Excluir</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
